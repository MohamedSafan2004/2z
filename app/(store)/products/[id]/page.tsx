          ...
          <div style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            <div style={{ marginBottom: "24px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
                ...
                {selectedSize && <p style={{ fontSize: "9px", letterSpacing: "0.15em", color: "rgba(240,237,230,0.35)" }}>{selectedVariant?.stockQuantity} left</p>}
              </div>
                ...
                {sizes.map((s) => {
                  ...
                  return (
                    <button key={s} className="size-btn"
                      ...
                      style={{ flex: 1, height: "48px", fontSize: "11px", letterSpacing: "0.15em", border: isSelected ? "1px solid #f0ede6" : "1px solid rgba(240,237,230,0.12)", color: outOfStock ? "rgba(240,237,230,0.15)" : isSelected ? "#f0ede6" : "rgba(240,237,230,0.5)", background: isSelected ? "rgba(240,237,230,0.06)" : "transparent", cursor: outOfStock ? "not-allowed" : "pointer", fontFamily: "Space Mono, monospace", transition: "all 0.2s", textDecoration: outOfStock ? "line-through" : "none" }}
                    >{s}</button>
                  )
                })}
              </div>
            ...
            <div style={{ marginBottom: "28px" }}>
              <p style={{ fontSize: "9px", letterSpacing: "0.25em", textTransform: "uppercase", color: "rgba(240,237,230,0.4)", marginBottom: "12px" }}>Quantity</p>
              <div style={{ display: "flex", alignItems: "center", width: "fit-content", border: "1px solid rgba(240,237,230,0.12)" }}>
                <button onClick={() => setQuantity(q => Math.max(1, q - 1))} style={{ width: "44px", height: "44px", background: "transparent", border: "none", color: quantity === 1 ? "rgba(240,237,230,0.2)" : "rgba(240,237,230,0.7)", cursor: quantity === 1 ? "not-allowed" : "pointer", fontSize: "18px", fontFamily: "Space Mono, monospace", transition: "color 0.2s" }}>−</button>
                ...
                <button onClick={() => setQuantity(q => Math.min(maxStock, q + 1))} style={{ width: "44px", height: "44px", background: "transparent", border: "none", color: quantity === maxStock ? "rgba(240,237,230,0.2)" : "rgba(240,237,230,0.7)", cursor: quantity === maxStock ? "not-allowed" : "pointer", fontSize: "18px", fontFamily: "Space Mono, monospace", transition: "color 0.2s" }}>+</button>
              </div>
            </div>
