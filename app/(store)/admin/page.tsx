      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "80px 16px 60px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "32px", flexWrap: "wrap", gap: "16px" }}>
          ...
          <div style={{ display: "flex", gap: "8px", marginTop: "8px", flexWrap: "wrap" }}>
            <button
              ...
              disabled={refreshing}
              style={{
                padding: "9px 18px", fontSize: "9px", letterSpacing: "0.2em",
                textTransform: "uppercase", fontFamily: "Space Mono, monospace",
                cursor: refreshing ? "not-allowed" : "pointer",
                background: "transparent",
                color: refreshing ? "rgba(240,237,230,0.3)" : "rgba(240,237,230,0.6)",
            ...
            <button
              ...
              style={{
                padding: "9px 18px", fontSize: "9px", letterSpacing: "0.2em",
                textTransform: "uppercase", fontFamily: "Space Mono, monospace",
                cursor: "pointer", background: "#f0ede6", color: "#080808",
        ...
        <input
          ...
          style={{
            ...
            fontSize: "10px", outline: "none", marginBottom: "16px",
        ...
        <div style={{ display: "flex", gap: "8px", marginBottom: "24px", flexWrap: "wrap" }}>
          {statuses.map((s) => (
            <button
              ...
              style={{
                padding: "6px 14px", fontSize: "8px", letterSpacing: "0.15em",
              ...
              return (
                <div key={order.id} style={{ border: "1px solid rgba(240,237,230,0.08)", padding: "20px" }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "16px", flexWrap: "wrap", gap: "8px" }}>
                    <div>
                      <p style={{ fontSize: "12px", color: "#f0ede6", letterSpacing: "0.1em", marginBottom: "4px" }}>
                        #{order.id.slice(0, 8).toUpperCase()}
                      </p>
                      <p style={{ fontSize: "8px", color: "rgba(240,237,230,0.25)", letterSpacing: "0.1em" }}>
                    ...
                    <div style={{ display: "flex", gap: "6px", alignItems: "center", flexWrap: "wrap" }}>
                      <span style={{
                        ...
                        padding: "3px 8px",
                        color: paymentStatusColor[order.paymentStatus] || "rgba(240,237,230,0.4)",
                        border: `1px solid ${paymentStatusColor[order.paymentStatus] || "rgba(240,237,230,0.15)"}`,
                      }}>
                  ...
                  <div style={{ borderTop: "1px solid rgba(240,237,230,0.06)", paddingTop: "14px", marginBottom: "14px" }}>
                    ...
                    {order.address && <p style={{ fontSize: "9px", color: "rgba(240,237,230,0.4)", marginTop: "6px", lineHeight: 1.7 }}>{order.address}</p>}
                  </div>
                  ...
                  <div style={{ borderTop: "1px solid rgba(240,237,230,0.06)", paddingTop: "14px", marginBottom: "14px" }}>
                    ...
                    {order.items.map((item: any) => (
                      <div key={item.id} style={{ display: "flex", justifyContent: "space-between", marginBottom: "4px" }}>
                        <p style={{ fontSize: "9px", color: "rgba(240,237,230,0.6)" }}>
                          {item.productNameSnapshot} / {item.colorSnapshot} / {item.sizeSnapshot} × {item.quantity}
                        </p>
                        <p style={{ fontSize: "9px", color: "rgba(240,237,230,0.4)" }}>
                  ...
                  <div style={{ borderTop: "1px solid rgba(240,237,230,0.06)", paddingTop: "14px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
                    ...
                    <select
                      ...
                      style={{
                        ...
                        border: "1px solid rgba(240,237,230,0.15)",
                        padding: "8px 12px", fontSize: "8px",
                        fontFamily: "Space Mono, monospace",
                        cursor: "pointer", letterSpacing: "0.1em", outline: "none",
                      }}
                    >
        ...
        {totalPages > 1 && (
          <div style={{ display: "flex", justifyContent: "center", gap: "8px", marginTop: "24px", flexWrap: "wrap" }}>
            <button
              ...
              disabled={page === 1}
              style={{ padding: "8px 16px", fontSize: "9px", background: "transparent", color: page === 1 ? "rgba(240,237,230,0.2)" : "#f0ede6", border: "1px solid rgba(240,237,230,0.15)", cursor: page === 1 ? "not-allowed" : "pointer", fontFamily: "Space Mono, monospace" }}
            >
              ←
            </button>
            ...
            <button
              ...
              style={{ padding: "8px 16px", fontSize: "9px", background: "transparent", color: page === totalPages ? "rgba(240,237,230,0.2)" : "#f0ede6", border: "1px solid rgba(240,237,230,0.15)", cursor: page === totalPages ? "not-allowed" : "pointer", fontFamily: "Space Mono, monospace" }}
            >
              →
            </button>
          </div>
