  ...
  return (
    <div style={{ background: "#080808", color: "#f0ede6", minHeight: "100vh", fontFamily: "Space Mono, monospace" }}>
      <div style={{ maxWidth: "700px", margin: "0 auto", padding: "80px 24px 60px" }}>
          ...
          <div style={{ background: "#0f0f0f", padding: "32px", marginBottom: "2px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div>
                ...
                <p style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "26px", fontWeight: 300, color: "#f0ede6", marginBottom: "8px" }}>2z.eg2004@gmail.com</p>
        ...
        {/* Policy Strip */}
        <div style={{ background: "#0f0f0f", padding: "32px", marginTop: "2px", display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "32px" }}>
          {[
