    ...
    <section className="reviews-section">
      <style>{`
        ...
        .reviews-track {
          ...
          /* مفيش touch-action مقفول على اتجاه واحد خالص. أي قيمة زي pan-x أو
             pan-y كانت بتقفل الاتجاه التاني بالكامل (موثّق في MDN: المتصفح
             بياخد تقاطع القيم بين العنصر وكل أصوله) — وده اللي كان بيمنع
             اليوزر من عمل سكرول رأسي عادي وهو ماسك على صورة الريفيو، لازم
             يسحب من برة الكارت بالظبط عشان يقدر ينزل/يطلع في الصفحة.
             overflow-y: hidden هنا هو اللي بيمنع الكاروسيل من عمل سكرول
             رأسي داخلي، وoverflow-x: auto هو اللي بيدّي السحب الأفقي —
             المتصفح بيوجه اللمسة تلقائيًا للاتجاه الصح من غير ما نحتاج نقفل
             حاجة بالـ touch-action. */
          touch-action: auto;
        }
