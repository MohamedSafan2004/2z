...
async function main() {
  // العروض الحالية (buy2get3 / buy3get5) بتتقفل بدل ما تتمسح، عشان
  // أي أوردر قديم لسه مرتبط بيها يفضل صالح تاريخيًا في الداتابيز
  await db.promotion.updateMany({
    where: { id: { in: ["promo-buy2get3", "promo-buy3get5"] } },
    data: { isActive: false },
  })
  ...
  console.log("✅ Promotions reverted: buy2get1, buy3get2 (buy2get3/buy3get5 اتقفلوا)")
}
